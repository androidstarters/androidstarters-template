...
import ${packageName}.MvpStarterApplication;
import ${packageName}.injection.component.ConfigPersistentComponent;
import ${packageName}.injection.component.DaggerConfigPersistentComponent;
import ${packageName}.injection.component.FragmentComponent;
